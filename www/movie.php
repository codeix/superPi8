...
$MAP=array('webm' => array('suffix' => 'webm', 'mime' => 'Content-type: video/webm'),
           'mp4' => array('suffix' => 'web.mp4', 'mime' => 'Content-type: video/mp4'));

$type = $_REQUEST['type'];
$path= $DIR.'/'.base64_decode($_REQUEST['movie']).'/'.base64_decode($_REQUEST['movie']).'.'.$MAP[$type]['suffix'];
